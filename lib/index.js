...
function Crawler(driver) {
  ...
  function get(url, opts, fn) {
    ...
    Object.getOwnPropertyNames(opts).forEach(function(k) {
      ctx.opts[k] = opts[k];
    });
